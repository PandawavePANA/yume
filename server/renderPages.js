...
export function renderRefundPage() {
  return layout(
    ...
    `<h1>환불정책</h1>
     ...
     <h2>제1조 (적용 범위)</h2>
     <p>이 정책은 유메가 제공하는 유료 요금제(구독)와 크레딧 추가 구매에 적용됩니다. 유메가 판매하는 상품은 모두 디지털 콘텐츠이며 배송되는 실물이 없습니다.</p>
     ...
     <li>결제 후 7일이 지난 경우, 남은 구독 기간에 대해 일할 계산하여 환불합니다. 이때에도 이미 사용한 크레딧에 해당하는 금액은 공제합니다.</li>
     ...
     <li>분기 기여도 보상으로 지급된 크레딧 및 물품</li>
     </ol>
